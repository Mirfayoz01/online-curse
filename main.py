...
from models.user import User, Course, Lesson, Rating, Comment
from schemas.course import CourseOut, CourseCreate
from schemas.lesson import LessonOut, LessonCreate
from schemas.rating import RatingOut, RatingCreate, CommentOut, CommentCreate
